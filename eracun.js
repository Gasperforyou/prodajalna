    ...
    if (!pesmi) {
      ...
      vrniStranke(function(napaka1, vrstice){
        ...
        odgovor.render('eslog', {
          ...
          postavkeRacuna: pesmi,
          narocnik: vrstice[parseInt(zahteva.session.userId)-1]
        }) ;
      });
    }
  })
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    vrniStranke(function(napaka3, stranke) {
      vrniRacune(function(napaka4, racuni) {
         if (napaka2){
            odgovor.render("prijava", {seznamStrank: stranke, seznamRacunov: racuni, sporocilo:"Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova."})
          } else {
            odgovor.render("prijava", {seznamStrank: stranke, seznamRacunov: racuni, sporocilo:"Stranka je bila uspešno registrirana."})
          }
      }) 
    });
  });
